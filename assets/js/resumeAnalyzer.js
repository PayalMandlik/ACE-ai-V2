...
function showResult(data) {
  ...
  resultTitle.textContent = data.title || 'Resume performance';
  resultSummary.textContent = data.summary || 'Here are your strengths, weaknesses, and missing skills.';
  displayItems(strengthsList, data.strengths);
  displayItems(weaknessesList, data.weaknesses);
  displayItems(missingSkillsList, data.missingSkills);
}
